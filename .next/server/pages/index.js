...
async function getStaticProps() {
  // fetch('./api/meetups')
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://jaydenduan888:Woshige+12A@cluster0.csksvfp.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
